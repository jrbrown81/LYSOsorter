...
#ifdef LYSOsorter_cxx
LYSOsorter::LYSOsorter(TTree *tree) : fChain(0)
{
...
LYSOsorter::~LYSOsorter()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t LYSOsorter::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t LYSOsorter::LoadTree(Long64_t entry)
{
...
void LYSOsorter::Init(TTree *tree)
{
...
void LYSOsorter::Show(Long64_t entry)
{
...
Int_t LYSOsorter::Cut(Long64_t entry)
{
